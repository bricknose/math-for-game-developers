...
export class Controls {
    ...
    private moveVector: Vector = new Vector(0, 0);
    ...
    {
        key.on('up', () => this.addMoveVector(keyVector.scale(-1)));
        key.on('down', () => this.addMoveVector(keyVector));
    }

    private addMoveVector(moveVector: Vector){
